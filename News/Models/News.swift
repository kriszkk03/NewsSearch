...
extension SearchResult {
    static let sampleData: SearchResult =
        SearchResult(
            ...
            totalResults: 2,
            articles: [
                Article(id: "1",source: Source(id: nil, name: "sourceName"), author: "Toth Krisztian", title: "This is the preview article", description: "this is a test data for the preview this is a test data for the preview this is a test data for the preview this is a test data for the preview this is a test data for the preview this is a test data for the preview this is a test data for the preview this is a test data for the preview", url: "www.nemmondommeg.hu", urlToImage: "www.eznagytitok.com", publishedAt: "2000-01.01", content: "lorem ipsum!"),
